...
export function ServicesClient({ services }: ServicesClientProps) {
    ...
    const ServiceCard = ({ service, className }: { service: Service; className?: string }) => {
        ...
        return (
            <div className={`group relative bg-white rounded-2xl p-8 shadow-sm border border-zinc-200 hover:shadow-xl hover:border-gold-200 transition-all duration-300 flex flex-col h-full ${className}`}>
                {service.badge && (
