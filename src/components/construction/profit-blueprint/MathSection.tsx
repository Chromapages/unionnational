...
export function MathSection() {
    ...
    return (
        <section className="py-10 md:py-20 lg:py-28 bg-white relative overflow-hidden border-y border-slate-200">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <RevealOnScroll delay={50}>
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl sm:rounded-3xl p-4 xs:p-6 sm:p-8 mb-8 sm:mb-10 max-w-2xl mx-auto text-center shadow-sm">
                        ...
                        <input
                            ...
                            className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-gold-500 focus:outline-none focus:ring-2 focus:ring-gold-500/20 touch-pan-x"
                        />
                ...
                <RevealOnScroll delay={100}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-8 mb-8 sm:mb-10">
                        {/* Low margin card */}
                        <div className="relative rounded-2xl sm:rounded-3xl border-2 border-slate-200 bg-slate-50 p-5 xs:p-7 sm:p-9">
                            <div className="flex items-center gap-2.5 mb-4 sm:mb-6">
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-slate-200 flex items-center justify-center shrink-0">
                                    <TrendingDown className="w-5 h-5 text-slate-600" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Industry Average</p>
                                    <p className="text-xl sm:text-2xl font-black text-slate-700 font-heading">5% Net Margin</p>
                                </div>
                            </div>
                            <div className="space-y-3 border-t border-slate-200 pt-4 sm:pt-5">
                                ...
                                <div className="border-t border-slate-200 pt-3 flex justify-between items-baseline">
                                    ...
                                    <span className="text-2xl xs:text-3xl font-black text-slate-700 tabular-nums">{fmt(revenue * LOW_MARGIN)}</span>
                                </div>
                        ...
                        {/* High margin card */}
                        <div className="relative rounded-2xl sm:rounded-3xl border-2 border-gold-500 bg-gradient-to-br from-gold-500 to-gold-600 p-5 xs:p-7 sm:p-9 shadow-2xl shadow-gold-500/20">
                            <div className="absolute -top-3 right-4 sm:-right-3 px-3 py-1 bg-brand-900 text-gold-400 text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg z-10">
                                Top Performers
                            </div>
                            <div className="flex items-center gap-2.5 mb-4 sm:mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl sm:text-2xl font-black text-white font-heading">18% Net Margin</p>
                                </div>
                            </div>
                            <div className="space-y-3 border-t border-white/20 pt-4 sm:pt-5">
                                ...
                                <div className="border-t border-white/20 pt-3 flex justify-between items-baseline">
                                    ...
                                    <span className="text-2xl xs:text-3xl font-black text-white tabular-nums">{fmt(revenue * HIGH_MARGIN)}</span>
                                </div>
                ...
                <RevealOnScroll delay={400}>
                    <p className="text-sm sm:text-base md:text-lg text-slate-700 leading-relaxed text-center max-w-2xl mx-auto mb-8 sm:mb-10 px-4 font-light">
                ...
                <RevealOnScroll delay={500}>
                    <div className="text-center px-4">
                        <a
                            href="#book-sales"
                            className="inline-flex items-center justify-center gap-2 px-6 py-4 xs:px-10 xs:py-5 bg-gold-500 hover:bg-gold-600 text-white font-black uppercase tracking-wider text-xs xs:text-sm sm:text-base rounded-full transition-colors shadow-lg shadow-gold-500/30 w-full xs:w-auto focus:outline-none focus:ring-2 focus:ring-gold-500 cursor-pointer"
                        >
                            <span>See How to Close the Gap</span>
                            <ArrowRight size={18} className="shrink-0" />
                        </a>
                        <p className="mt-3 text-[10px] xs:text-xs text-slate-500 uppercase tracking-wider font-bold">
