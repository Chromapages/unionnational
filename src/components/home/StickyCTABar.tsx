            ...
            >
                <div className="flex items-center gap-4">
                    <div className="flex-1">
                        <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider mb-0.5">Free Consultation</p>
                        <p className="text-sm font-bold text-brand-900 leading-tight">Stop Overpaying Taxes</p>
                    </div>
                    <Link
                        href={ctaUrl}
