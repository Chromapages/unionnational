# Who We Serve Section Redesign - Implementation Plan

> **For AI:** Use the executing-plans approach to implement this plan task-by-task.

**Goal:** Rebuild the "Who We Serve" section as a full-width Industry Showcase Carousel with generated imagery, treating all 5 industries equally.

**Architecture:** Replace the existing sidebar-tab layout with an Embla Carousel. Each slide is a full-width card featuring an industry illustration, headline, description, benefits list, and CTA. The carousel will be swipeable on mobile and use navigation arrows on desktop.

**Tech Stack:** Next.js 16, TypeScript, Tailwind CSS, Embla Carousel (already installed), Lucide Icons
...
#### [MODIFY] [IndustriesSection.tsx](file:///f:/WORK/UNION%20NATIONAL%20TAX/unionnational/src/components/home/IndustriesSection.tsx)

Complete rewrite of the component to use Embla Carousel with the following structure:

**Key Changes:**
1. Replace sidebar-tab layout with carousel
2. Add industry images to each slide
3. Add navigation arrows for desktop
4. Add pagination dots
5. Maintain reveal animations
...
### Task 1: Update Industries Data Structure

**Files:**
- Modify: `src/components/home/IndustriesSection.tsx`

**Step 1: Update the industries array to include image paths**
...
```bash
git add src/components/home/IndustriesSection.tsx
git commit -m "feat(industries): add image paths to industries data"
```

---

### Task 2: Implement Embla Carousel Structure

**Files:**
- Modify: `src/components/home/IndustriesSection.tsx`

**Step 1: Import Embla Carousel hooks and add carousel setup**
...
```bash
git add src/components/home/IndustriesSection.tsx
git commit -m "feat(industries): add Embla carousel setup"
```

---

### Task 3: Create Carousel Slide Component

**Files:**
- Modify: `src/components/home/IndustriesSection.tsx`

**Step 1: Create the slide JSX structure**
...
```bash
git add src/components/home/IndustriesSection.tsx
git commit -m "feat(industries): implement carousel slide structure with images"
```
...
Remove the old `tabsRef` and `activeIndex` state, replace with the new carousel state.
...
**Expected:** The Industries section should now display as a carousel with:
...
- **375px (Mobile):** Full-width slides, swipe navigation
- **768px (Tablet):** 80% width slides, arrows hidden
- **1024px+ (Desktop):** 60% width slides, arrows visible

**Step 4: Commit**

```bash
git add src/components/home/IndustriesSection.tsx
git commit -m "feat(industries): complete carousel implementation with all features"
```
...
### Manual Verification
1. View the homepage at `http://localhost:3000`
2. Scroll to the "Who We Serve" section
3. Verify carousel functionality:
   - [ ] Slides are visible and centered
...
| Asset | Path |
|-------|------|
| Construction Image | `/images/industries/construction.png` |
| Real Estate Image | `/images/industries/real-estate.png` |
| Food Industry Image | `/images/industries/food.png` |
| E-Commerce Image | `/images/industries/ecommerce.png` |
| Insurance Image | `/images/industries/insurance.png` |
