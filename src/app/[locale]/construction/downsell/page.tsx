...
export default async function ConstructionDownsellPage(props: { params: Promise<{ locale: string }> }) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 font-sans selection:bg-cyan-500 selection:text-slate-900 flex flex-col relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-cyan-500/5 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="w-full h-20 flex items-center justify-between px-6 border-b border-slate-900 relative z-20 bg-slate-950/50 backdrop-blur-sm">
                <span className="font-heading font-bold text-white text-lg tracking-wide opacity-80">
                    Union National Tax <span className="text-cyan-500">Construction</span>
                </span>
                <Link
            ...
            <main className="flex-grow flex flex-col items-center justify-center p-6 relative z-10 text-center">
                ...
                <div className="max-w-xl w-full space-y-12">
                    ...
                    {/* Offer Card */}
                    <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden group hover:border-cyan-500/30 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                        ...
                        <div className="space-y-8 relative z-10">
                            <div>
                                <h2 className="text-2xl font-bold text-white font-heading mb-2">
                                    The Construction Tax Saver Bundle
                                </h2>
                                <p className="text-slate-400 text-sm">
                                    Everything you need to stay compliant and maximize deductions without the CFO price tag.
                                </p>
                            </div>
                            ...
                            <Link
                                href="/contact?package=construction-tax-saver"
                                className="block w-full py-4 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white font-bold text-lg shadow-lg shadow-cyan-900/20 hover:shadow-cyan-500/20 transition-all transform hover:-translate-y-1"
                            >
