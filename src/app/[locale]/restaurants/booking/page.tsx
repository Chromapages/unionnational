        ...
        <div className="min-h-screen bg-brand-900 font-sans selection:bg-orange-500 selection:text-white flex flex-col">
            ...
            <div className="w-full border-b border-brand-800 bg-brand-900/90 backdrop-blur-sm fixed top-0 z-50">
                ...
                <div className="w-full h-1 bg-brand-800">
                    <div className="h-full bg-orange-500 w-full shadow-[0_0_10px_rgba(249,115,22,0.5)]"></div>
                </div>
            </div>
            ...
            <main className="flex-grow pt-24 pb-20 px-4 sm:px-6 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start relative z-10">
                    ...
                    <div className="lg:sticky lg:top-32 space-y-8">
                        ...
                        {/* Approval Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-sm font-bold uppercase tracking-widest">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-4xl md:text-5xl font-bold text-white font-heading leading-tight">
                                Your <span className="text-orange-500">Priority Access</span> has been Unlocked.
                            </h1>
                        ...
                        <div className="relative group rounded-2xl p-[2px] bg-gradient-to-r from-gold-500/20 via-gold-400/40 to-gold-500/20">
                            ...
                            <div className="relative bg-brand-900 rounded-2xl p-6 md:p-8 overflow-hidden">
                                ...
                                <p className="text-brand-200 text-sm leading-relaxed border-t border-brand-800 pt-4 mt-2">
                                    Book your call today to lock in this incentive using our corporate travel partnerships. <span className="text-gold-400 italic">Valid for new Kitchen Command Clients only.</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 pt-4">
                            ...
                            {[
                                "Deep dive into your food costs & labor margins",
                                "Roadmap to increase profitability immediately",
                                "Approval for the Kitchen Command Center program"
                            ].map((item, i) => (
